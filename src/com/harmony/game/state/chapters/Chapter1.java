...
public class Chapter1 extends Chapter {
    ...
    private NPC npcAmber;
    private NPC npcMrsCaren;
    private NPC npcMatt;
    ...
    public Chapter1() { super("/tile/places/kebir.tmx"); }
    ...
    public void onCreate() {
        ...
        Camera.position = new Vector2f(1000f, 1000f);
        Camera.setDefaultPosition();

        controller = new C1Controller(this);
        
        nextLevelInvisible = new NextLevelInvisible(new Vector2f(2364f, 665f), player, 320, 64);
    ...
    private void handleNPC() {
        super.npcs.add(npcMrCrow = new NPC(new Vector2f(1686f, 3050f), "Mr. Crow", tileManager.getObjectsMap(),
        ...
        super.npcs.add(npcAmber = new NPC(new Vector2f(3520f, 1974f), "Amber", tileManager.getObjectsMap(),
        ...
        super.npcs.add(npcMrsCaren = new NPC(new Vector2f(2644f, 1933f), "Mrs. Caren", tileManager.getObjectsMap(),
                player, console, new Sprite("/entity/npc/mrs-caren.png", 64, 64), 128, 128,
                "Hi Deary..."));
        super.npcs.add(npcMatt = new NPC(new Vector2f(2141f, 2572f), "Matt", tileManager.getObjectsMap(),
